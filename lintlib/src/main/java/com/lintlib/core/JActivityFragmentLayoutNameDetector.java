 ...
 */
public class JActivityFragmentLayoutNameDetector extends Detector
        implements Detector.JavaScanner {

    public static final Issue ACTIVITY_LAYOUT_NAME_ISSUE = Issue.create("ActivityLayoutNameNotPrefixed",
            "You should name an activity-layout file with prefix `activity_`",
            "You should name an activity-layout file with prefix `activity_`. For example, `activity_main.xml`.",
            Category.CORRECTNESS,
            5,
            Severity.ERROR,
            new Implementation(JActivityFragmentLayoutNameDetector.class,
                    Scope.JAVA_FILE_SCOPE));

    public static final Issue FRAGMENT_LAYOUT_NAME_ISSUE = Issue.create("FragmentLayoutNameNotPrefixed",
            "You should name an fragment-layout file with prefix `fragment_`",
            "You should name an fragment-layout file with prefix `fragment_`. For example, `fragment_main.xml`.",
            Category.CORRECTNESS,
            5,
            Severity.ERROR,
            new Implementation(JActivityFragmentLayoutNameDetector.class,
