 ...
 */
public abstract class WrapperBaseDetector extends Detector implements Detector.JavaScanner {
    protected String mWrapperClassName;
    protected String[] mTargetClassNames;

    /** Constructs a new {@link WrapperBaseDetector} check */
    public WrapperBaseDetector() {
